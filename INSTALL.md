...
```
php -r "copy('https://raw.githubusercontent.com/radianceteam/ton-client-php-ext/1.28.0/installer.php', 'installer.php');"
...
php installer.php -v 1.28.0
php installer.php -v 1.28.0 -T
```

On Linux you may need to run installation step using `sudo`:

```
sudo php installer.php -v 1.28.0
```

The last command `php installer.php -v 1.28.0 -T` is to test the new installation.
...
```
php installer.php -v 1.28.0 -o install.log -V
```
