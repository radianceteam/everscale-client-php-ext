...
```
php -r "copy('https://raw.githubusercontent.com/radianceteam/ton-client-php-ext/1.27.1/installer.php', 'installer.php');"
...
php installer.php -v 1.27.1
php installer.php -v 1.27.1 -T
```

On Linux you may need to run installation step using `sudo`:

```
sudo php installer.php -v 1.27.1
```

The last command `php installer.php -v 1.27.1 -T` is to test the new installation.
...
```
php installer.php -v 1.27.1 -o install.log -V
```
