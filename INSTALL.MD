...
```
php -r "copy('https://raw.githubusercontent.com/radianceteam/ton-client-php-ext/1.6.2/installer.php', 'installer.php');"
...
php installer.php -v 1.6.2
php installer.php -v 1.6.2 -T
```

On Linux you may need to run installation step using `sudo`:

```
sudo php installer.php -v 1.6.2
```

The last command `php installer.php -v 1.6.2 -T` is to test the new installation.
...
```
php installer.php -v 1.6.2 -o install.log -V
```
