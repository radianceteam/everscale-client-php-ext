...
```
php -r "copy('https://raw.githubusercontent.com/radianceteam/ton-client-php-ext/1.6.3/installer.php', 'installer.php');"
php -r "if (hash_file('sha384', 'installer.php') === 'e2478dda0e179de7a7485fa360719685f11d6a2baf7931a315e6f06ded3771024732fca77677143eb086548cd2ebd36d') { echo 'Installer verified'; } else { echo 'Installer corrupt'; exit(1); } echo PHP_EOL;"
php installer.php -v 1.6.3
php installer.php -v 1.6.3 -T
```

On Linux you may need to run installation step using `sudo`:

```
sudo php installer.php -v 1.6.3
```

The last command `php installer.php -v 1.6.3 -T` is to test the new installation.
...
```
php installer.php -v 1.6.3 -o install.log -V
```
R
